 ...
 * Use this for server-side operations that require admin access like user management.
 * 
 * IMPORTANT: Never expose this client or its operations to the client side.
 */
